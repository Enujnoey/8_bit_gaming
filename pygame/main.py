...
"""
'Stranded' pygame for PRG Module 2020
@authors: styssk
"""

import pygame as pg #need to install ;a library used to run pygame functions
import sys #used to exit the game in different OS
from random import choice, random
from os import path #used to find files in different OS
#the file was split so it is easier to look at
from settings import * 
from sprites import *
from tilemap import *

# HUD functions
def draw_player_radiation_resistance(surf, x, y, pct):
    if pct < 0:
        pct = 0
    BAR_LENGTH = 100
    BAR_HEIGHT = 20
